...
function Footer() {
  return (
    <div className="flex  bg-zinc-900 text-gray-300 p-10 space-x-4">
      {/* Social Media Icons */}
      <div className="flex space-x-8">
        ...
        <FaInstagram className="h-12 w-5 md-12 cursor-pointer hover:text-pink-500 transition-colors duration-300" />
      </div>
