  ...
  return (
    <div className="bg-zinc-900 text-gray-300">
      ...
      <div className="flex flex-col lg:flex-row justify-center items-center bg-zinc-900 p-12 space-x-0 md:gap-6 lg:space-x-6 space-y-8 md:space-y-0">
          ...
          {/* Card 1 */}
          <div className="w-full sm:w-1/3 lg:w-1/4 h-[470px] lg:h-[430px] flex flex-col bg-zinc-700 rounded-lg shadow-lg transform hover:scale-105 transition duration-300 ease-in-out">
        ...
        {/* Card 2 */}
        <div className="w-full sm:w-1/3 lg:w-1/4 flex flex-col h-[470px] lg:h-[430px] bg-zinc-700 rounded-lg shadow-lg transform hover:scale-105 transition duration-300 ease-in-out">
